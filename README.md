...
<button onclick="copyToClipboard('#install-command')">Copy Command</button>
...
<button onclick="copyToClipboard('#install-command')">Copy Command</button> to initiate the experiment run.
